...
4. The script offers the user some options:
   ...
   e. To crop the black frame and remove the on-screen logo from a WGVU Create-TV (local alternate PBS channel) recording,
   f. To remove the on-screen logo from a WGVU (local PBS channel) recording
